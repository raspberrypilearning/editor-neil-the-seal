...
The original sign is still on show. Add a `hide`{:class="block3looks"} block to the end of the script, so only the six clones are left visible.
...
Click the green flag. Six stop signs appear around the town.
