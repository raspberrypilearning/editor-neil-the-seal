...
Right-click `seal1` and choose **duplicate** to make `seal2`. In the paint editor, move each of Neil's legs a little, so `seal2` is in a different pose to `seal1`.
...
Click the green flag and move Neil around. His two costumes swap back and forth, so he looks like he's waddling.
